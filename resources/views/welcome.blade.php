    ...
    <div class="container flex flex-col mx-auto bg-white">
        ...
        <div class="grid w-full grid-cols-1 my-auto mt-12 mb-8 md:grid-cols-2 xl:gap-14 md:gap-5">
            <div class="flex flex-col justify-center col-span-1 text-center lg:text-start">
                ...
                <h1 class="mb-8 text-4xl font-extrabold leading-tight lg:text-6xl text-dark-grey-900">Easy Parking,
                    Premium Service, Secure Spaces.
                </h1>
                <p class="mb-6 text-base font-normal leading-7 lg:w-3/4 text-grey-900">
                    Say farewell to the hassle of finding parking spaces. Embrace the fastest, most efficient, and
                    stylish parking
                    solution around. Seriously.
                </p>

                <div class="flex flex-col items-center gap-4 lg:flex-row">
                    <button
                        class="flex items-center py-4 text-sm font-bold text-white px-7 bg-purple-blue-500 hover:bg-purple-blue-600 focus:ring-4 focus:ring-purple-blue-100 transition duration-300 rounded-xl">Check
                        Availability</button>
                    <button
